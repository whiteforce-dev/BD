...
<div class="col-sm-12">
    ...
    <div class="col-sm-12">
        <div class="upload_image_box">
            ...
            <div class="btn-group" data-toggle="modal" data-target="#modal_crop">
                <img style="height:300px; width:auto" src=" {{ !empty($preview) ? url($preview) : 'http                                                                                 s://cdn.dribbble.com/users/1753953/screenshots/3818675/media/b376f45b3edd274a18c6296df22854fb.gif' }}" alt=""
                    id="myresultimage">
            </div>
            <br>
        </div>
