                        ...
                        <div class="d-sm-flex  d-block align-items-center">
                            <div class="d-flex mb-sm-0 mb-3 me-auto align-items-center">
                                ...
                                <div class="media-body">
                                    ...
                                    <h3 class="mb-0 font-w600 fs-22"><i class="fas fa-tree"></i> Holidays Report </h3>
                                </div>
                                <div style="margin-left: 580px;">

                                    <a href="{{ url('addHoliday') }}" class="btn btn-primary rounded ms-2">Add Holiday</a>
                                </div>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td >
                                            <div class="media align-items-center tbl-img">
                                                <img class="img-fluid  me-3 d-none d-xl-inline-block" width="70" src="{{ $holidays->image }}" alt="DexignZone">
                                            </div>
                                        </td>
                                        <td style="width: 0px;">
                                            <div class="media-body">
                                                <h4 style="font-size: 20px;" class="font-w400 mb-1 ">{{ $holidays->name }}</h4>
                                            </div>
                                        </td>
                                        <td class="d-none d-lg-table-cell"><h5>{{ $holidays->date }}</h5></td>
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ url('editHoliday',$holidays->id) }}" class="btn btn-secondary btn-rounded text-white btn-sm px-4">Edit</a>
                                                <a href="{{ url('deleteHoliday',$holidays->id) }}" class="btn btn-outline-danger btn-rounded btn-sm ms-2 px-4">Delete</a>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforeach
