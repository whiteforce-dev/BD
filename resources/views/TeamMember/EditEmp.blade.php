                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="{{ url('/update-employee', $Emp->id) }}" method="POST" role="form text-left"
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="name" class="form-control"
                                            placeholder="enter your name" name="name" required="required" value="{{ $Emp->name }}" />
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="email" class="form-control"
                                            placeholder="enter your email " name="email" value="{{ $Emp->email }}" />
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="firstname" class="form-control"
                                            placeholder="enter your Mobile Number" name="mobile" required="required" value="{{ $Emp->mobile }}" />
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="type" class="form-control">
                                            ...
                                            @foreach ($Type as $Types)
                                                @if ($Types->name == (isset($Emp) ? $Emp->type : 'Select Designation'))
                                                    <option selected value="{{ $Types->name }}">{{ $Types->name }}
                                                    </option>
                                                @else
                                    ...
                                    <div class="col-sm-9">
                                        <select name="created_by" class="form-control">
                                            ...
                                            @foreach ($Manager as $manager)
                                                @if ($manager->id == (isset($Emp) ? $Emp->created_by : 'Select Manager'))
                                                    <option selected value="{{ $manager->id }}">{{ $manager->name }}
                                                    </option>
                                                @else
                                ...
                                <div class="mb-3 row ">
                                    <div class="col-sm-4 ">
                                        <button type="submit" class="btn btn-primary btn-block"
                                            style="margin-left: 300px">Update</button>
                                    </div>
                                </div>
                            </form>
                        </div>
