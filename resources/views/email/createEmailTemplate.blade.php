                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form action = "{{ url('storeEmailTemplate') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    ...
                                    <div class="basic-form">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" rows="4"  id="dz-password" class="tinymce-editor"style="height:150px" name="description" placeholder="Descriptions"  ></textarea>
                                            </div>
                                            @error('description')
                                            <p class="text-danger">{{ $message }}</p>
                                            @enderror
