                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form action = "{{ url('updateEnquiryType', $preview->id ) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label class="form-label">Proposal Type</label>
                                    <input type="text" class="form-control input-default " placeholder="Enter Enquiry Type" name="name" value="{{$preview->name}}" required>
                                </div>
                                    <div class="basic-form">
                                            <div class="mb-3">
