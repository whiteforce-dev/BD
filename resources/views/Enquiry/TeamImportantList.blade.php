...
<div class="content-body">
    <div class="container-fluid">
        <form action="{{url('multySelectMemberImportantList ')}}" method="POST">
            @csrf
                        ...
                        <div class="card-body py-3 py-md-2">
                            <div class="d-sm-flex  d-block align-items-center">
                                <div class="d-flex mb-sm-0 mb-3 me-auto align-items-center">
                                    ...
                                    @php
                                    $user = Auth::user();
                                    $impCounts = App\Models\Enquiry::whereHas('GetCreatedby', function ($query) use ($user) {
                                            $query->where('created_by', $user->id)->where('is_important', 1);
                                       })->count();
                                    @endphp
                            ...
                            <div class="card overflow-hidden" style="    border: 1px solid #e9dcd7; height: calc(100% - 39px); transform: scaleY(1);">
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a class="btn btn-outline-primary btn-rounded mt-3 px-5" href="{{url('team-member-importantlist'.'/'.$users->id)}}" style="width: 100%; font-size:0.9rem; border-color:#bfbfd9; ">Important Enquiry List</a>
                                    </div>
                                </div>
