                ...
                <div class="d-flex mb-sm-0 mb-3 me-auto align-items-center"
                    ...
                    <div class="media-body">
                        ...
                        <div class="row" style="width: 100%;">
                            <div class="col-4">
                                <h3 class="mb-0 font-w600 fs-22" style="font-size: 1.2rem !important;">
                                    Total Enquiries - {{ $Details1 }}</h3>
                            </div>
                            <div class="col-md-4" style="max-width: 25% !important; margin-top: -8px;">
                            ...
                            <div class="col-md-4" style="max-width: 25% !important; margin-top: -8px;">
                                <button type="submit" class="btn btn-primary col-md-12" style="margin-top: -6px">Send
                                    Mail</button>
                            </div>
        ...
        <section class="cards-one" style=" font-family: Poppins, sans-serif;">
            <div class="head">
                <div class="first-head">
                    ...
                    <div class="enquiry">
                        <h3>{{ isset($obj->company_name) ? $obj->company_name : 'N/A' }}</h3> <input type="checkbox"
