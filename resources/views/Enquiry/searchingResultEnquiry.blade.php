                ...
                <div class="d-flex mb-sm-0 mb-3 me-auto align-items-center"
                    ...
                    <div class="media-body" style="padding-left: 15px;">
                        ...
                        <div class="row" style="width: 180%;">
                            ...
                            <div class="col-md-4"
                                style="max-width: 11% !important;
                                    margin-top: -8px;">
                                <select class="form-control" name="template" id="template_id" value="template"
                            ...
                            <div class="col-md-4"
                                style=" max-width: 8% !important;
                                    margin-top: -8px;">
                                <button type="button" class="btn btn-primary col-md-12"
                                    style="margin-top: -4px; font-size:0.9rem; height:34px;" onclick="sendEmail()">Send
                                    Mail</button>
                            </div>
...
<script>
    ...
    //    alert (template_id);
        ...
        $.get("{{ url('email-send') }}",{checkedVals:checkedVals, template_id:template_id},function(response){
if(response ==1){
    Swal.fire(
  'Good job!',
  'Mail has been sent!',
